                    ...
                    <CardContent>
                      <Tabs defaultValue="materials-info" className="w-full">
                        <TabsList className="grid w-full grid-cols-3">
                          <TabsTrigger value="materials-info">Materials Info</TabsTrigger>
                          <TabsTrigger value="exposure-control">Exposure Control Plan</TabsTrigger>
                          <TabsTrigger value="additional-detail">Additional Detail</TabsTrigger>
                        </TabsList>
