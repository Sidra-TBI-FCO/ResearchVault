    ...
    const researchContractsData = [
      {
        ...
        irbProtocol: "IRB-2023-089",
        qnrfNumber: "NPRP-001-2023",
        ...
        documents: {
          agreement: "contract_agreement_cnt_2023_001.pdf",
          budget: "contract_budget_cnt_2023_001.pdf",
          technical_specs: "genomics_equipment_specs.pdf"
        }
      },
      {
        researchActivityId: researchActivityEntities[1].id,
        ...
        officeFormStatus: "complete",
        documents: {
          agreement: "contract_agreement_cnt_2023_002.pdf",
          budget: "contract_budget_cnt_2023_002.pdf"
        }
      },
      {
        researchActivityId: researchActivityEntities[2].id,
        contractNumber: "CNT-2023-003",
        title: "Tumor Microenvironment Research Grant",
        leadPIId: scientistsArray[0].id,
        requestedByUserId: adminUser.id,
        irbProtocol: "IRB-2023-156",
        qnrfNumber: "NPRP-003-2023",
        requestState: "active",
        fundingSourceCategory: "Research Grant",
        contractorName: "Qatar Foundation",
        internalCostSidra: 0,
        internalCostCounterparty: 1200000,
        moneyOut: 0,
        isPORelevant: false,
        contractType: "Grant",
        status: "active",
        description: "Multi-year research grant for investigating tumor microenvironment dynamics in cancer progression.",
        startDate: new Date("2023-09-01"),
        endDate: new Date("2026-08-31"),
        contractValue: 1200000,
        currency: "QAR",
        initiationRequestedAt: new Date("2023-07-20"),
        reminderEmail: "oncology@example.com",
        officeFormStatus: "complete",
        documents: {
          agreement: "contract_agreement_cnt_2023_003.pdf",
          budget: "contract_budget_cnt_2023_003.pdf",
          research_proposal: "tumor_research_proposal.pdf"
        }
      },
      {
        researchActivityId: researchActivityEntities[3].id,
        contractNumber: "CNT-2023-004",
        title: "Alzheimer Protein Research Collaboration",
        leadPIId: scientistsArray[2].id,
        requestedByUserId: adminUser.id,
        irbProtocol: "IRB-2023-089",
        fundingSourceCategory: "Academic Collaboration",
        contractorName: "NeuroScience Institute",
        internalCostSidra: 320000,
        internalCostCounterparty: 280000,
        moneyOut: 320000,
        isPORelevant: true,
        contractType: "Collaboration",
        status: "pending",
        description: "Collaborative research agreement for studying protein aggregation mechanisms in Alzheimer's disease.",
        startDate: new Date("2024-01-01"),
        endDate: new Date("2025-12-31"),
        contractValue: 600000,
        currency: "USD",
        initiationRequestedAt: new Date("2023-11-15"),
        reminderEmail: "neuroscience@example.com",
        officeFormStatus: "pending_review",
        documents: {
          agreement: "contract_agreement_cnt_2023_004.pdf",
          budget: "contract_budget_cnt_2023_004.pdf"
        }
      }
    ];
